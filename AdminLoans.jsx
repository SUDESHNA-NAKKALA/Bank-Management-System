...
const AdminLoans = () => {
    ...
    const fetchLoans = async () =>{
        console.log("xyz")
        await axios.get('http://localhost:5000/fetch-loans').then(
            (response) =>{
                console.log(response,"Main Response")
                console.log(response.status,"Admin Loans Hit")
    ...
    const approveLoan = async(id) =>{
        console.log("HIT")
        await axios.put('http://localhost:5000/approve-loan', {id}).then(
            (response)=>{
                alert("Loan approved!!");
                fetchLoans();
            }
    ...
    const declineLoan = async(id) =>{
        console.log(id)
        await axios.put('http://localhost:5000/decline-loan', {id}).then(
            (response)=>{
                alert("Loan Declined!!");
                fetchLoans();
            }
