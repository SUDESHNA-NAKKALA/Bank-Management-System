...
const Deposits = () => {
    ...
    const fetchDepositsData = async () => {
        ...
        try {
            if (userid) {
                ...
                await axios.get(`http://localhost:5000/fetch-deposits`).then(
                    async (response) => {
                        console.log(response.data, "deposit amount excellent");
    ...
    const createNewDeposit = async () => {
        ...
        const newDepositDetails = {
            depositName: newDepositName, customerId: userid,
        ...
        await axios.post('http://localhost:5000/new-deposit', newDepositDetails).then(
            async (response) => {
                                ...
                                return (
                                    ...
                                    <div className="user-deposit" >
                                        ...
                                        <span>
                                            ...
                                            <p><b>Maturity Date: </b> {deposit.matureDate} </p>
                                        </span>
                    ...
                    <div className="new-user-deposits-container">
                        ...
                        <div className="input-row">
                            ...
                            <div className="form-floating input-row21">
                                <input type="number" className="form-control" id="user-depositAmountInput" placeholder="Amount" onChange={(e) => setNewDepositAmount(Math.abs(e.target.value))} value={newDepositAmount} />
                        ...
                        <p> * I here by agree to all the terms & conditions to make this deposit. I agree to gain interest with the dynamic interests depending up on the market conditions. I agree that at any case I cannot break deposit before maturity date.</p>
