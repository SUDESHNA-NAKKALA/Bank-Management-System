...
const Home = () => {
  ...
  const fetchUserData = async () => {
    ...
    try {
      if (userid) {
        await axios.get(`http://localhost:5000/user-details/${userid}`).then(
          async (response) => {
        ...
        await axios.get(`http://localhost:3000/transactions`).then(
          async (response) => {
  ...
  const sendMoney = async () => {
    ...
    console.log(sendingAmount,"sending scooby");
    console.log(balance,"balance velma");
    if (sendingAmount <= balance) {
      console.log("HIT")

      await axios.post('http://localhost:5000/send-money', sendTransactionData).then(
        async (response) => {
